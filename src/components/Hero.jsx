    ...
    return (
        <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden
            ...
            <motion.h1
                ...
                viewport={{ once: true }}
                className='font-medium text-4xl sm:text-5xl md:text-6xl xl:text[84px] xl:leading-[95px] max-w-5xl'>
            ...
            <motion.p
                ...
                viewport={{ once: true }}
                className='text-gray-500 font-medium text-sm sm:text-lg dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>
